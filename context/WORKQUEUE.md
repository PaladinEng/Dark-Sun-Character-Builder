...
- [ ] Expand SRD coverage (additional spells, equipment, backgrounds)
- [ ] Implement modelable feat effects when the runtime grows reaction/conditional support
  (e.g. Mobile +10 speed, Heavy Armor Master damage reduction, Observant +5 passive bonuses)
