...
async function ingestSettings() {
  ...
  const profile = {
    ...
    backgroundReplacementIds: [
      "darksun:background:acrobat",
      "darksun:background:athasian-minstrel",
      "darksun:background:dune-trader",
      "darksun:background:gladiator",
      "darksun:background:noble-adept",
      "darksun:background:nomad",
      "darksun:background:primal-guardian",
      "darksun:background:psionic-adept",
      "darksun:background:slave",
      "darksun:background:templar",
      "darksun:background:veiled-alliance",
